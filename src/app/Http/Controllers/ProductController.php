...
class ProductController extends Controller
{
    ...
    public function update(UpdateRequest $request, $product_id)
    {
        ...
        return redirect()->route('products.index', $product_id)->with('success', '商品を更新しました');
    }
    ...
    public function search(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return response()->json([
                ...
                // カスタムページネーションビューを使用してリンクを生成
                'pagination' => (string) $products->appends(request()->query())->links('pagination.custom')
            ]);
        }
